...
def crear(id_inscripcion: UUID) -> Certificado:
    certificado = Certificado(id_inscripcion=id_inscripcion)
    db.add(certificado)
    db.commit()
...
def actualizar(id_certificado: UUID, **kwargs: dict) -> Optional[Certificado]:
